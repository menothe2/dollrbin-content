...
export const TERMS_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'The seller has 5 days to respond to a dispute. If the seller doesn\'t respond, the dispute is automatically resolved in the buyer\'s favor with a full refund.',
